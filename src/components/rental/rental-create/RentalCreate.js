...
export class RentalCreate extends React.Component {
    ...
    render() {
        if (this.state.redirect) {
            return <Redirect to={{pathname: '/rentals'}}></Redirect>
        }
            ...
            <section id='newRental'>
                <div className='bwm-form'>
                    ...
                    <div className='col-md-5'>
                        ...
                        <RentalCreateForm submitCb={this.createRental} options={this.rentalCategories} errors={this.state.errors}></RentalCreateForm>
                    </div>
